...
def compute_harris_response(im, sigma=6):
    ...
    return Wdet / Wtr
def get_harris_points(harrisim,min_dist=6,threshold=0.1):
...
if __name__ == '__main__':
    im = array(Image.open('bigtu.png').convert('L'))
    #im = array(Image.open('empire.jpg').convert('L'))
    harrisim = compute_harris_response(im)
    filtered_coords = get_harris_points(harrisim,7)
